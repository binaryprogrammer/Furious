...
namespace FuriousLibrary_XNA4.Collision
{
    /// <summary>
    ...
    public struct BoundingOrientedBox : IEquatable<BoundingOrientedBox>
    {
        ...
        {
            return new BoundingOrientedBox(Vector3.Transform(Center, rotation) + translation, HalfExtent, Orientation * rotation);
        }
        ...
        {
            return new BoundingOrientedBox(Vector3.Transform(Center * scale, rotation) + translation, HalfExtent * scale, Orientation * rotation);
        }
