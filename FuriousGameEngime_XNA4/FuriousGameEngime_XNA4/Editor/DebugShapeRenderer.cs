...
namespace FuriousGameEngime_XNA4
{
    ...
    public static class DebugShapeRenderer
    {
        ...
        //[Conditional("DEBUG")]
        //public static void AddOrientedBoundingBox(BoundingBox orientedBox, Color color)
        //{
        //    AddOrientedBoundingBox(orientedBox, color, 0f);
        //}

        //[Conditional("DEBUG")]
        //public static void AddOrientedBoundingBox(BoundingBox orientedBox, Color color, float life)
        //{
        //    DebugShape shape = GetShapeForLines(12, life);

        //    orientedBox.GetCorners(corners, 0);
