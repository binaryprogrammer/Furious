...
namespace FuriousGameEngime_XNA4.Screens
{
    ...
    class MainMenuScreen : MenuScreen
    {
            ...
            : base(Resources.MainMenu)
        {
            ...
            MenuEntry singlePlayerMenuEntry = new MenuEntry(this as MenuScreen, Resources.SinglePlayer);
            MenuEntry exitMenuEntry = new MenuEntry(this as MenuScreen, Resources.Exit);
        ...
        {
            MessageBoxScreen confirmExitMessageBox = new MessageBoxScreen(Resources.ConfirmExitSample);
