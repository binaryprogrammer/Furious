...
namespace FuriousGameEngime_XNA4.Animation
{
    /// <summary>
    ...
    public class AnimationPlayer
    {
        ...
        public void UpdateFromBeginningAndStopAtTheEnd(TimeSpan time, Matrix rootTransform)
        {
            UpdateBoneTransformsFromBeginning(time);
            UpdateWorldTransforms(rootTransform);
            UpdateSkinTransforms();
        }

        void UpdateBoneTransformsFromBeginning(TimeSpan time)
        {
