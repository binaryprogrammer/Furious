...
namespace HeightmapImporter
{
    ...
    public class HeightMapInfoContent
    {
        ...
        /// array.
        /// </summary>
        public HeightMapInfoContent(MeshContent terrainMesh, float terrainScale, int terrainWidth, int terrainLength)
        {
    ...
    public class HeightMapInfoWriter : ContentTypeWriter<HeightMapInfoContent>
    {
        ...
        {
            return "FuriousGameEngime_XNA4.HeightMapInfo, FuriousGameEngime_XNA4, Version=1.0.0.0, Culture=neutral";
        }
        ...
        {
            return "FuriousGameEngime_XNA4.HeightMapInfoReader, FuriousGameEngime_XNA4, Version=1.0.0.0, Culture=neutral";
        }
    }
}
