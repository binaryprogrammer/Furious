...
namespace FuriousGameEngime_XNA4.Enviornment
{
    ...
    public class HeightMapInfo
    {
        ...
        /// <summary>
        /// This 2D array of floats tells us the height that each position in the heightmap is.
        /// </summary>
        public readonly float[,] heights;

        /// <summary>
        /// this 2D array of Vectors tells us the normal at each given location on the heightmap
        /// </summary>
        ...
        public HeightMapInfo(float[,] heights, Vector3[,] normals, float terrainScale)
        {
            ...
            position.X = -(heights.GetLength(0) - 1) / 2.0f * terrainScale;
            position.Z = -(heights.GetLength(1) - 1) / 2.0f * terrainScale;
        }
        ...
        public bool IsOnHeightmap(Vector3 position)
        {
            ...
            // heightmap.
            return (positionOnHeightmap.X > 0 && positionOnHeightmap.X < width && positionOnHeightmap.Z > 0 && positionOnHeightmap.Z < height);
        }
        ...
        public void GetHeightAndNormal (Vector3 position, out float height, out Vector3 normal)
        {
            ...
            Vector3 topNormal = Vector3.Lerp(normals[left, top], normals[left + 1, top], xNormalized);

            Vector3 bottomNormal = Vector3.Lerp(normals[left, top + 1], normals[left + 1, top + 1], xNormalized);
